    ...
    return (
        <>
            ...
            <section className="flex flex-col p-9 justify-center bg-gray-400/25 h-screen items-center">
                <div className="flex flex-col w-full lg:w-3/4 h-full gap-6 p-6 justify-center transition-all delay-150">
                    <div className="flex lg:flex-row flex-col w-full gap-6">

                        <a href="/Owner" className="flex flex-col justify-between w-full h-full bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 p-6 rounded-3xl shadow-xl transition-shadow delay-100 hover:shadow-2xl">
                        ...
                        <a href="/Manager" className="flex flex-col justify-between w-full h-full bg-gradient-to-br from-green-100 via-green-200 to-green-300 p-6 rounded-3xl shadow-xl transition-shadow delay-100 hover:shadow-2xl">
                            <div className="flex flex-row w-full">
                                <h1 className="flex w-3/4 text-lg lg:text-2xl opacity-70">
                                    Manager
                                </h1>
                    ...
                    <div className="flex lg:flex-row flex-col w-full gap-6">
                        ...
                        <a href="/Staff" className="flex flex-col justify-between w-full h-full bg-gradient-to-br from-pink-100 via-pink-200 to-pink-300 p-6 rounded-3xl shadow-xl transition-shadow delay-100 hover:shadow-2xl">
                            <div className="flex flex-row w-full">
                                <h1 className="flex w-3/4 text-lg lg:text-2xl opacity-70">
                                    Staff
                                </h1>
                        ...
                        <a href="/Sign-up/NewStoreRegistration" className="flex flex-col justify-between w-full h-full bg-gradient-to-br from-violet-100 via-violet-200 to-violet-300 p-6 rounded-3xl shadow-xl transition-shadow delay-100 hover:shadow-2xl">
                            <div className="flex flex-row w-full">
                                <h1 className="flex w-3/4 text-lg lg:text-2xl opacity-70">
                                    Register
                                </h1>
