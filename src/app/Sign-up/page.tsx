    ...
    <>
      ...
      <section className="flex flex-col p-9 justify-center bg-gray-400/25 h-screen items-center">
        <div className="flex flex-wrap w-full gap-6">
          ...
          <a href="/Customer/offline_shopping" className="flex flex-col justify-between w-fit h-fit bg-gradient-to-br from-blue-50 to-blue-200 p-6 rounded-3xl shadow-lg transition-shadow delay-100 hover:shadow-xl">
            <div className="flex flex-row w-full">
              <h1 className="flex w-3/4 text-lg lg:text-2xl opacity-70">
                Start with offline shopping
              </h1>
              <div className="flex bg-transparent rounded-full p-4 w-1/4 h-fit">
          ...
          <a href="/Customer/check_Inventory" className="flex flex-col justify-between w-fit h-fit bg-gradient-to-br from-blue-50 to-blue-200 p-6 rounded-3xl shadow-lg transition-shadow delay-100 hover:shadow-xl">
            <div className="flex flex-row w-full">
              <h1 className="flex w-3/4 text-lg lg:text-2xl opacity-70">
