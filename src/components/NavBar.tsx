    ...
    return (
        <>
            <nav className={`fixed w-full py-2 my-5 rounded-3xl z-10 transition-all duration-300 ${isScrolled ? 'shadow-md backdrop-blur-3xl' : ''}`}>
                <header className="text-slate-700 container items-center justify-between relative mx-auto flex flex-row overflow-hidden px-4 py-4 lg:flex-row lg:items-center">
